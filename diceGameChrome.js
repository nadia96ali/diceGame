var win=false;
function start(){
alert("Enable Audio by Click on the Icon");
}
...
document.querySelector("#resultTextP1").textContent = "player 1 - player2";
...
document.querySelector("i").setAttribute("class","fas fa-volume-up");
roll();
